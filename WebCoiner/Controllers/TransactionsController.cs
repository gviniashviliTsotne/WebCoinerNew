...
namespace WebCoiner.Controllers
{
    ...
    public class TransactionsController : Controller
    {
        ...
        {
            var transactions = db.Transactions.Include(t => t.AspNetUser).OrderByDescending(x=>x.Id);
        ...
        public ActionResult Create([Bind(Include = "UserId,Tokens,BTC,Approved")] Transaction transaction)
        {
